...
void marger(int* begin, int* end, int* begin_second, int* end_second, int* dest) {
  ...
  void merget_sort(int* begin_first_array, int* end_first_array, int* begin_second_array, int* end_second_array, int* begin_dest) {
	  /*
	  //auto leught_arr3{ (end_first_array - begin_first_array) + (end_second_array - begin_second_array) };
	  for (int it{}; it != leught_arr3; it++) {
		  if (*begin_first_array > *begin_second_array) {
			  if (begin_second_array != end_second_array) {
  ...
  bool equal(int* begin_first_array, int* end_first_array, int* begin_second_array, int* end_second_array) {
	  ...
	  auto size_2{ end_second_array - begin_second_array };
		...
		for (; begin_first_array != end_first_array; begin_first_array++, begin_second_array++) {
			if (*begin_first_array != *begin_second_array) {
				return false;
			}
